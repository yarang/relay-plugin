...
|---|---|---|---|---|---|
| **아키텍트** | `codex` | `gpt-5.3-codex` | premium | grasp | plan |
| **백엔드 개발자** | `codex` | `gpt-5.3-codex` | premium | tangle | acceptEdits |
| **프론트엔드 개발자** | `codex` | `gpt-5.3-codex` | premium | tangle | acceptEdits |
| **DB 설계자** | `codex` | `gpt-5.3-codex` | premium | grasp | plan |
| **TDD 오케스트레이터** | `codex` | `gpt-5.3-codex` | premium | tangle | acceptEdits |
| **QA 엔지니어** | `codex-spark` | `gpt-5.3-codex-spark` | standard | ink | default |
| **코드 리뷰어** | `codex-spark` | `gpt-5.3-codex-spark` | premium | ink | default |
| **보안 감사** | `codex` | `gpt-5.3-codex` | premium | ink | default |
| **DevOps** | `codex` | `gpt-5.2-codex` | standard | ink | acceptEdits |
| **디버거** | `codex` | `gpt-5.2-codex` | standard | tangle, ink | acceptEdits |
| **AI 엔지니어** | `gemini` | `gemini-3-pro-preview` | premium | probe, tangle | plan |
| **UX 리서처** | `gemini` | `gemini-3-pro-preview` | standard | probe, grasp | plan |
| **비즈니스 분석가** | `gemini` | `gemini-3-pro-preview` | standard | probe, grasp | plan |
| **마케팅 전략가** | `gemini` | `gemini-3-pro-preview` | standard | probe, grasp | plan |
| **재무 분석가** | `gemini` | `gemini-3-pro-preview` | standard | probe, grasp | plan |
| **법무 고문** | `gemini` | `gemini-3-pro-preview` | standard | probe, grasp | plan |
| **문서 설계자** | `gemini` | `gemini-3-pro-preview` | standard | ink | default |
| **컨텍스트 관리자** | `gemini-fast` | `gemini-3-flash-preview` | standard | all | plan |
| **다이어그램 전문가** | `gemini-fast` | `gemini-3-flash-preview` | trivial | grasp, ink | plan |
| **전략 분석가** | `claude-opus` | `claude-opus-4-6` | premium | probe, grasp | plan |
| **연구 종합가** | `claude-opus` | `claude-opus-4-6` | premium | probe | plan |
| **Python 전문가** | `codex` | `gpt-5.3-codex` | premium | tangle | acceptEdits |
| **TypeScript 전문가** | `codex` | `gpt-5.3-codex` | premium | tangle | acceptEdits |
